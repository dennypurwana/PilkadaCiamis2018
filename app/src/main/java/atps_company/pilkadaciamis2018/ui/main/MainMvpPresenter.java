...
public interface MainMvpPresenter<V extends MainMvpView> extends MvpPresenter<V> {
    ...
    void onDrawerSeputarPilkadaClick();

    void onDrawerMaskotPilkadaClick();

    void onDrawerBerandaClick();

    void onDrawerPersebaranTpsClick();

    void onDrawerHubungiKamiClick();

    void onDrawerPetugasBawasluClick();
